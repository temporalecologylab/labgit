...
{\Large My guidelines for use of generative AI when working with me}\footnote{I (Lizzie) try to share this policy with everyone, regardless of whether I think you use genAI or not.}
...
\item I understand that you may want to use it to edit your grammar.\footnote{I realize genAI is increasingly embedded in many programs and I am generally okay with use for fixing typos, verb-noun agreement and extremely minor fixes of the sort that were once done without genAI.}  If you want to use generative AI as a tool to help you edit your writing, you must agree that you will not use generative AI beyond this with telling me, and show me that you know the different levels of using generative AI and how to properly disclose them. Thus, you need to:
\begin{enumerate}
...
If you have (or think maybe you have) failed to follow these guidelines, please tell me and we can talk about it.\footnote{If you don't tell me, there may be other consequences.}
