...
\begin{itemize}
\item Follow our shared \href{https://github.com/temporalecologylab/labgit/blob/master/expectations/values_aspirations.pdf}{lab values}.
\item Attend lab meetings (when we have them). % Bring snacks when asked or for any special occasion you think of.
...
\item Be especially considerate of the administrative staff (the folks who work in the FCS office, the financial staff etc.). This includes: replying to any emails they personally send you promptly and politely, submitting your receipts within a reasonable timeframe with all the information filled out clearly (and scan your receipts so that they are not giant files), and generally remembering that they are working to help us all in the lab, so treating them poorly in any way reflects poorly on all of us. 
...
\item Follow lab \href{https://github.com/temporalecologylab/labgit/blob/master/expectations/writing/tempeco_writing.pdf}{guidelines on writing}.
\item Follow lab guidelines on the use of \href{https://github.com/temporalecologylab/labgit/blob/master/expectations/genAI_labguidelines.pdf}{generative AI} and disclosure of your use of it more broadly. 
