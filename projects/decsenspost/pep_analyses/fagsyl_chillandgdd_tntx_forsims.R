...
if(use.10yr==TRUE){
  write.csv(post, file="~/Desktop/Misc/Ospree Misc/postfagsylten.csv", row.names=FALSE)
} else {
  write.csv(post, file="~/Desktop/Misc/Ospree Misc/postfagsyl.csv", row.names=FALSE)
}
...
if(use.10yr==FALSE){
  ...
  write.csv(mid, file="~/Desktop/Misc/Ospree misc/midfagsyl.csv", row.names=FALSE)
}
...
if(use.10yr==TRUE){
  pre <- read.csv("~/Desktop/Misc/Ospree Misc/prefagsylten.csv")
  post <- read.csv("~/Desktop/Misc/Ospree Misc/postfagsylten.csv")
} else{
  pre <- read.csv("~/Desktop/Misc/Ospree Misc/prefagsyl.csv")
  post <- read.csv("~/Desktop/Misc/Ospree Misc/postfagsyl.csv")
  mid <- read.csv("~/Desktop/Misc/Ospree Misc/midfagsyl.csv")
}
...
if(use.10yr==TRUE){
  ...
  write.csv(full.site.nonas, file="fagsyl_allchillsandgdds_nomat_twentyyr.csv", row.names = FALSE)
}

##################################################################################################
############################### MEAN TEMP instead of GDD #########################################
##################################################################################################
#full.site.nonas <- read.csv("fagsyl_allchillsandgdds_nomat_twentyyr.csv", header = TRUE)
