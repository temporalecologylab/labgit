...
if(use.10yr==TRUE){
  write.csv(pre, file="~/Desktop/Misc/Ospree Misc/prebetpenten.csv", row.names=FALSE)
} else {
  write.csv(pre, file="~/Desktop/Misc/Ospree Misc/prebetpen.csv", row.names=FALSE)
}
...
if(use.10yr==TRUE){
  write.csv(post, file="~/Desktop/Misc/Ospree Misc/postbetpenten.csv", row.names=FALSE)
} else {
  write.csv(post, file="~/Desktop/Misc/Ospree Misc/postbetpen.csv", row.names=FALSE)
}
...
if(use.10yr==TRUE){
  pre <- read.csv("~/Desktop/Misc/Ospree Misc/prebetpenten.csv")
  post <- read.csv("~/Desktop/Misc/Ospree Misc/postbetpenten.csv")
} else{
  pre <- read.csv("~/Desktop/Misc/Ospree Misc/prebetpen.csv")
  post <- read.csv("~/Desktop/Misc/Ospree Misc/postbetpen.csv")
  mid <- read.csv("~/Desktop/Misc/Ospree Misc/midbetpen.csv")
}
...
if(use.10yr==TRUE){
  write.csv(full.site.nonas, file="betpen_allchillsandgdds_nomat_tenyr.csv", row.names = FALSE)
} else {
  write.csv(full.site.nonas, file="betpen_allchillsandgdds_nomat_twentyyr.csv", row.names = FALSE)
}

##################################################################################################
############################### MEAN TEMP instead of GDD #########################################
##################################################################################################
#full.site.nonas <- read.csv("betpen_allchillsandgdds_nomat_twentyyr.csv", header = TRUE)
